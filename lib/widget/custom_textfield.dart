...
class CustomTextfield extends StatefulWidget {
  const CustomTextfield(this.title, this.hintText, this.icon, {this.hasSuffix = false, this.isNumber = false, this.isEmail = false, this.isPhone = false});
  final String hintText, title;
  final IconData icon;
  final bool hasSuffix, isNumber, isEmail, isPhone;
